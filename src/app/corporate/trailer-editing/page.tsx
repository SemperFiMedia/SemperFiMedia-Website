  ...
  return (
    <>
      ...
      <main>
        <section className="bg-gradient-to-br from-gunpowder via-dusk-teal to-black px-6 pt-28 pb-16 md:px-12 md:pt-36 md:pb-24">
          <div className="mx-auto max-w-[1200px]">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <BrassButton href="#tiers" variant="outline">
                See tier pricing
              </BrassButton>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-[1200px]">
            ...
            <div className="mt-10">
              <BrassButton href="#color" variant="outline">
                See color-work pricing →
              </BrassButton>
            </div>
          </div>
        </section>

        <section id="color" className="scroll-mt-32 border-t border-brass/15 bg-gunpowder px-6 py-20 md:px-12 md:py-24">
          <div className="mx-auto max-w-[1200px]">
        ...
        <section id="why" className="scroll-mt-32 bg-gunpowder px-6 py-20 md:px-12 md:py-24">
